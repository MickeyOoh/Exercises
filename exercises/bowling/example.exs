...
defmodule Bowling do
  ...
  defp update_score(1, game, score) do
    ...
    scores = List.replace_at(
              game.scores,current_frame - 1,[score,0])
    cond do
      score == 10 ->
        %{game | current_frame: current_frame + 1,
          scores: scores}
      true ->
  ...
  defp update_score(2, game, score) do
    ...
    new_scores = List.replace_at(old_scores,
                                 current_frame - 1, new_frame_values)
